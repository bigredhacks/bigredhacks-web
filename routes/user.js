...
module.exports = function (io) {
     ...
     * @apiGroup User
     */
    router.post('/team/add', middle.requireCornellRegistrationOpen, function (req, res, next) {
     ...
     * @apiGroup User
     */
    router.get('/team/leave', middle.requireCornellRegistrationOpen, function (req, res, next) {
